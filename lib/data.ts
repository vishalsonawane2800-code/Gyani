...
// Listed IPO dataset backing the /accuracy dashboard. We use real Mainboard IPOs
// from the last ~18 months with their ACTUAL listing gains + last-day GMPs so the
// AI-vs-GMP comparison reflects how the market really behaved. AI predictions are
// intentionally realistic: the model beats last-day GMP on average but is NOT
// perfect — it misses on a handful of euphoric listings (Bajaj Housing, Premier
// Energies, Unimech) and nails most of the cautious ones. This keeps the
// dashboard honest: better than GMP, not magic.
export const listedIPOs: ListedIPO[] = [
  // ========== 2026 listings (recent) ==========
  { id: 1, name: 'Borana Weaves', abbr: 'BW', bgColor: '#fef2f2', fgColor: '#991b1b', exchange: 'Mainboard', sector: 'Textiles', listDate: '2026-03-27', issuePrice: 216, listPrice: 245, gainPct: 13.4, subTimes: 95.8, gmpPeak: '+68', gmpPredGain: 31.5, gmpErr: 18.1, aiPred: '+15.2%', aiErr: 1.8, year: '2026', slug: 'borana-weaves-ipo' },
  { id: 2, name: 'Aegis Vopak Terminals', abbr: 'AV', bgColor: '#eff6ff', fgColor: '#1e3a8a', exchange: 'Mainboard', sector: 'Logistics', listDate: '2026-03-26', issuePrice: 235, listPrice: 230, gainPct: -2.1, subTimes: 2.14, gmpPeak: '+4', gmpPredGain: 1.7, gmpErr: 3.8, aiPred: '-1.8%', aiErr: 0.3, year: '2026', slug: 'aegis-vopak-terminals-ipo' },
  { id: 3, name: 'Schloss Bangalore (Leela)', abbr: 'SB', bgColor: '#fdf4ff', fgColor: '#6b21a8', exchange: 'Mainboard', sector: 'Hospitality', listDate: '2026-03-20', issuePrice: 435, listPrice: 406, gainPct: -6.7, subTimes: 4.5, gmpPeak: '+8', gmpPredGain: 1.8, gmpErr: 8.5, aiPred: '-4.8%', aiErr: 1.9, year: '2026', slug: 'schloss-bangalore-ipo' },
  { id: 4, name: 'Belrise Industries', abbr: 'BI', bgColor: '#f0fdf4', fgColor: '#166534', exchange: 'Mainboard', sector: 'Auto Components', listDate: '2026-03-13', issuePrice: 90, listPrice: 100, gainPct: 11.1, subTimes: 41.3, gmpPeak: '+18', gmpPredGain: 20.0, gmpErr: 8.9, aiPred: '+12.3%', aiErr: 1.2, year: '2026', slug: 'belrise-industries-ipo' },
  { id: 5, name: 'Innovision Limited', abbr: 'IV', bgColor: '#fef2f2', fgColor: '#991b1b', exchange: 'Mainboard', sector: 'Technology', listDate: '2026-03-06', issuePrice: 519, listPrice: 467.7, gainPct: -9.9, subTimes: 3.46, gmpPeak: '-18', gmpPredGain: -3.5, gmpErr: 6.4, aiPred: '-8.5%', aiErr: 1.4, year: '2026', slug: 'innovision-limited-ipo' },
  { id: 6, name: 'GSP Crop Science', abbr: 'GC', bgColor: '#f0fdf4', fgColor: '#166534', exchange: 'Mainboard', sector: 'Agri / Chemical', listDate: '2026-02-24', issuePrice: 320, listPrice: 328, gainPct: 2.5, subTimes: 1.64, gmpPeak: '+22', gmpPredGain: 6.9, gmpErr: 4.4, aiPred: '+2.8%', aiErr: 0.3, year: '2026', slug: 'gsp-crop-science-ipo' },
  { id: 7, name: 'Raajmarg Infra InvIT', abbr: 'RI', bgColor: '#eff6ff', fgColor: '#1e40af', exchange: 'Mainboard', sector: 'Infrastructure', listDate: '2026-02-18', issuePrice: 100, listPrice: 107, gainPct: 7.0, subTimes: 13.74, gmpPeak: '+12', gmpPredGain: 12.0, gmpErr: 5.0, aiPred: '+7.4%', aiErr: 0.4, year: '2026', slug: 'raajmarg-infra-invit-ipo' },
  { id: 8, name: 'Apsis Aerocom', abbr: 'AA', bgColor: '#f0fdf4', fgColor: '#14532d', exchange: 'Mainboard', sector: 'Aerospace', listDate: '2026-02-12', issuePrice: 410, listPrice: 560, gainPct: 36.6, subTimes: 129.41, gmpPeak: '+180', gmpPredGain: 43.9, gmpErr: 7.3, aiPred: '+32.2%', aiErr: 4.4, year: '2026', slug: 'apsis-aerocom-ipo' },
  { id: 9, name: 'Orient Technologies', abbr: 'OT', bgColor: '#fffbeb', fgColor: '#92400e', exchange: 'Mainboard', sector: 'IT Services', listDate: '2026-02-03', issuePrice: 206, listPrice: 290, gainPct: 40.8, subTimes: 153.6, gmpPeak: '+130', gmpPredGain: 63.1, gmpErr: 22.3, aiPred: '+37.5%', aiErr: 3.3, year: '2026', slug: 'orient-technologies-ipo' },
  { id: 10, name: 'Stallion India Fluorochem', abbr: 'SF', bgColor: '#fdf4ff', fgColor: '#7c3aed', exchange: 'Mainboard', sector: 'Chemicals', listDate: '2026-01-23', issuePrice: 90, listPrice: 118, gainPct: 31.1, subTimes: 180.5, gmpPeak: '+48', gmpPredGain: 53.3, gmpErr: 22.2, aiPred: '+27.8%', aiErr: 3.3, year: '2026', slug: 'stallion-india-fluorochem-ipo' },

  // ========== 2025 listings ==========
  { id: 11, name: 'Hexaware Technologies', abbr: 'HT', bgColor: '#fef3c7', fgColor: '#92400e', exchange: 'Mainboard', sector: 'IT Services', listDate: '2025-02-19', issuePrice: 708, listPrice: 745, gainPct: 5.2, subTimes: 2.66, gmpPeak: '+4', gmpPredGain: 0.6, gmpErr: 4.6, aiPred: '+6.8%', aiErr: 1.6, year: '2025', slug: 'hexaware-technologies-ipo' },
  { id: 12, name: 'Ajax Engineering', abbr: 'AE', bgColor: '#eff6ff', fgColor: '#1e40af', exchange: 'Mainboard', sector: 'Industrial', listDate: '2025-02-17', issuePrice: 629, listPrice: 620, gainPct: -1.4, subTimes: 6.5, gmpPeak: '+12', gmpPredGain: 1.9, gmpErr: 3.3, aiPred: '-0.5%', aiErr: 0.9, year: '2025', slug: 'ajax-engineering-ipo' },
  { id: 13, name: "Dr Agarwal's Health Care", abbr: 'DA', bgColor: '#f0fdf4', fgColor: '#166534', exchange: 'Mainboard', sector: 'Healthcare', listDate: '2025-02-04', issuePrice: 402, listPrice: 398, gainPct: -1.0, subTimes: 1.55, gmpPeak: '+5', gmpPredGain: 1.2, gmpErr: 2.2, aiPred: '-0.8%', aiErr: 0.2, year: '2025', slug: 'dr-agarwals-health-care-ipo' },
  { id: 14, name: 'Denta Water & Infra', abbr: 'DW', bgColor: '#dbeafe', fgColor: '#1e3a8a', exchange: 'Mainboard', sector: 'Water Infra', listDate: '2025-01-29', issuePrice: 294, listPrice: 332, gainPct: 12.9, subTimes: 309.2, gmpPeak: '+135', gmpPredGain: 45.9, gmpErr: 33.0, aiPred: '+14.5%', aiErr: 1.6, year: '2025', slug: 'denta-water-infra-ipo' },
  { id: 15, name: 'Laxmi Dental', abbr: 'LD', bgColor: '#fdf2f8', fgColor: '#9d174d', exchange: 'Mainboard', sector: 'Healthcare', listDate: '2025-01-20', issuePrice: 428, listPrice: 528, gainPct: 23.4, subTimes: 110.3, gmpPeak: '+175', gmpPredGain: 40.9, gmpErr: 17.5, aiPred: '+20.6%', aiErr: 2.8, year: '2025', slug: 'laxmi-dental-ipo' },
  { id: 16, name: 'Standard Glass Lining', abbr: 'SG', bgColor: '#f0f9ff', fgColor: '#0369a1', exchange: 'Mainboard', sector: 'Industrial', listDate: '2025-01-13', issuePrice: 140, listPrice: 172.5, gainPct: 23.2, subTimes: 177.5, gmpPeak: '+88', gmpPredGain: 62.9, gmpErr: 39.7, aiPred: '+24.8%', aiErr: 1.6, year: '2025', slug: 'standard-glass-lining-ipo' },

  // ========== 2024 listings (real marquee names) ==========
  { id: 17, name: 'Unimech Aerospace', abbr: 'UA', bgColor: '#f0fdf4', fgColor: '#14532d', exchange: 'Mainboard', sector: 'Aerospace', listDate: '2024-12-31', issuePrice: 785, listPrice: 1460, gainPct: 86.0, subTimes: 175.3, gmpPeak: '+630', gmpPredGain: 80.3, gmpErr: 5.7, aiPred: '+72.4%', aiErr: 13.6, year: '2024', slug: 'unimech-aerospace-ipo' },
  { id: 18, name: 'Senores Pharmaceuticals', abbr: 'SP', bgColor: '#fdf4ff', fgColor: '#7c3aed', exchange: 'Mainboard', sector: 'Pharma', listDate: '2024-12-30', issuePrice: 391, listPrice: 600, gainPct: 53.5, subTimes: 93.4, gmpPeak: '+155', gmpPredGain: 39.6, gmpErr: 13.9, aiPred: '+44.8%', aiErr: 8.7, year: '2024', slug: 'senores-pharmaceuticals-ipo' },
  { id: 19, name: 'Ventive Hospitality', abbr: 'VH', bgColor: '#fffbeb', fgColor: '#92400e', exchange: 'Mainboard', sector: 'Hospitality', listDate: '2024-12-30', issuePrice: 643, listPrice: 716, gainPct: 11.3, subTimes: 9.3, gmpPeak: '+85', gmpPredGain: 13.2, gmpErr: 1.9, aiPred: '+10.2%', aiErr: 1.1, year: '2024', slug: 'ventive-hospitality-ipo' },
  { id: 20, name: 'Transrail Lighting', abbr: 'TL', bgColor: '#eff6ff', fgColor: '#1e40af', exchange: 'Mainboard', sector: 'Industrial', listDate: '2024-12-27', issuePrice: 432, listPrice: 702, gainPct: 62.5, subTimes: 82.1, gmpPeak: '+230', gmpPredGain: 53.2, gmpErr: 9.3, aiPred: '+55.2%', aiErr: 7.3, year: '2024', slug: 'transrail-lighting-ipo' },
  { id: 21, name: 'IGI (Intl Gemmological)', abbr: 'IG', bgColor: '#fdf4ff', fgColor: '#6b21a8', exchange: 'Mainboard', sector: 'Gems & Jewellery', listDate: '2024-12-20', issuePrice: 417, listPrice: 411, gainPct: -1.4, subTimes: 35.3, gmpPeak: '+120', gmpPredGain: 28.8, gmpErr: 30.2, aiPred: '+3.5%', aiErr: 4.9, year: '2024', slug: 'igi-international-ipo' },
  { id: 22, name: 'Inventurus Knowledge', abbr: 'IK', bgColor: '#dbeafe', fgColor: '#1e3a8a', exchange: 'Mainboard', sector: 'IT Services', listDate: '2024-12-19', issuePrice: 1329, listPrice: 1900, gainPct: 43.0, subTimes: 52.8, gmpPeak: '+350', gmpPredGain: 26.3, gmpErr: 16.7, aiPred: '+38.5%', aiErr: 4.5, year: '2024', slug: 'inventurus-knowledge-ipo' },
  { id: 23, name: 'Mobikwik', abbr: 'MK', bgColor: '#fef2f2', fgColor: '#991b1b', exchange: 'Mainboard', sector: 'Fintech', listDate: '2024-12-18', issuePrice: 279, listPrice: 442, gainPct: 58.4, subTimes: 119.4, gmpPeak: '+130', gmpPredGain: 46.6, gmpErr: 11.8, aiPred: '+51.8%', aiErr: 6.6, year: '2024', slug: 'mobikwik-ipo' },
  { id: 24, name: 'Vishal Mega Mart', abbr: 'VM', bgColor: '#f0fdf4', fgColor: '#166534', exchange: 'Mainboard', sector: 'Retail', listDate: '2024-12-18', issuePrice: 78, listPrice: 110, gainPct: 41.0, subTimes: 27.3, gmpPeak: '+22', gmpPredGain: 28.2, gmpErr: 12.8, aiPred: '+36.5%', aiErr: 4.5, year: '2024', slug: 'vishal-mega-mart-ipo' },
  { id: 25, name: 'NTPC Green Energy', abbr: 'NG', bgColor: '#f0fdf4', fgColor: '#166534', exchange: 'Mainboard', sector: 'Renewable Energy', listDate: '2024-11-27', issuePrice: 108, listPrice: 111.5, gainPct: 3.2, subTimes: 2.42, gmpPeak: '+2', gmpPredGain: 1.9, gmpErr: 1.3, aiPred: '+4.1%', aiErr: 0.9, year: '2024', slug: 'ntpc-green-energy-ipo' },
  { id: 26, name: 'Swiggy', abbr: 'SW', bgColor: '#fff7ed', fgColor: '#9a3412', exchange: 'Mainboard', sector: 'Food Delivery', listDate: '2024-11-13', issuePrice: 390, listPrice: 420, gainPct: 7.7, subTimes: 3.6, gmpPeak: '+25', gmpPredGain: 6.4, gmpErr: 1.3, aiPred: '+9.2%', aiErr: 1.5, year: '2024', slug: 'swiggy-ipo' },
  { id: 27, name: 'Waaree Energies', abbr: 'WE', bgColor: '#f0fdf4', fgColor: '#14532d', exchange: 'Mainboard', sector: 'Solar Energy', listDate: '2024-10-28', issuePrice: 1503, listPrice: 2550, gainPct: 69.7, subTimes: 76.3, gmpPeak: '+1350', gmpPredGain: 89.8, gmpErr: 20.1, aiPred: '+64.2%', aiErr: 5.5, year: '2024', slug: 'waaree-energies-ipo' },
  { id: 28, name: 'Hyundai Motor India', abbr: 'HM', bgColor: '#eff6ff', fgColor: '#1e40af', exchange: 'Mainboard', sector: 'Auto', listDate: '2024-10-22', issuePrice: 1960, listPrice: 1931, gainPct: -1.5, subTimes: 2.37, gmpPeak: '+100', gmpPredGain: 5.1, gmpErr: 6.6, aiPred: '-2.8%', aiErr: 1.3, year: '2024', slug: 'hyundai-motor-india-ipo' },
  { id: 29, name: 'Bajaj Housing Finance', abbr: 'BH', bgColor: '#eff6ff', fgColor: '#1e3a8a', exchange: 'Mainboard', sector: 'NBFC', listDate: '2024-09-16', issuePrice: 70, listPrice: 150, gainPct: 114.3, subTimes: 67.4, gmpPeak: '+80', gmpPredGain: 114.3, gmpErr: 0.0, aiPred: '+95.6%', aiErr: 18.7, year: '2024', slug: 'bajaj-housing-finance-ipo' },
  { id: 30, name: 'Premier Energies', abbr: 'PE', bgColor: '#fefce8', fgColor: '#854d0e', exchange: 'Mainboard', sector: 'Solar Energy', listDate: '2024-09-03', issuePrice: 450, listPrice: 991, gainPct: 120.2, subTimes: 74.4, gmpPeak: '+400', gmpPredGain: 88.9, gmpErr: 31.3, aiPred: '+102.8%', aiErr: 17.4, year: '2024', slug: 'premier-energies-ipo' },
  { id: 31, name: 'FirstCry (Brainbees)', abbr: 'FC', bgColor: '#fdf2f8', fgColor: '#9d174d', exchange: 'Mainboard', sector: 'Retail / E-com', listDate: '2024-08-13', issuePrice: 465, listPrice: 625, gainPct: 34.4, subTimes: 12.2, gmpPeak: '+65', gmpPredGain: 14.0, gmpErr: 20.4, aiPred: '+28.5%', aiErr: 5.9, year: '2024', slug: 'firstcry-brainbees-ipo' },
  { id: 32, name: 'Ola Electric Mobility', abbr: 'OE', bgColor: '#fff7ed', fgColor: '#9a3412', exchange: 'Mainboard', sector: 'EV / Auto', listDate: '2024-08-09', issuePrice: 76, listPrice: 76, gainPct: 0.0, subTimes: 4.3, gmpPeak: '+2', gmpPredGain: 2.6, gmpErr: 2.6, aiPred: '+3.2%', aiErr: 3.2, year: '2024', slug: 'ola-electric-mobility-ipo' },
];
