...
export const currentIPOs: IPO[] = [
  {
    ...
    gmp: 5,
    gmpPercent: 5.1,
    gmpLastUpdated: '2026-04-05T09:30:00',
    estListPrice: 103,
    subscription: { total: 0.32, retail: '0.28x', nii: '0.35x', qib: '0.34x', day: 4, isFinal: false },
    aiPrediction: -8.5,
    aiConfidence: 62,
    sentimentScore: 28,
    ...
    gmpHistory: [
      { date: '2026-04-05', gmp: 5, gmpPercent: 5.1, source: 'IPOWatch' },
      { date: '2026-04-04', gmp: 8, gmpPercent: 8.2, source: 'IPOWatch' },
      { date: '2026-04-03', gmp: 10, gmpPercent: 10.2, source: 'InvestorGain' },
      { date: '2026-04-02', gmp: 12, gmpPercent: 12.2, source: 'IPOWatch' },
      { date: '2026-04-01', gmp: 15, gmpPercent: 15.3, source: 'IPOWatch' },
      { date: '2026-03-31', gmp: 18, gmpPercent: 18.4, source: 'IPOWatch' },
    ],
    subscriptionHistory: [
      { date: '2026-04-05', time: '11:00', retail: 0.28, nii: 0.35, qib: 0.34, total: 0.32 },
      { date: '2026-04-04', time: '17:00', retail: 0.22, nii: 0.28, qib: 0.26, total: 0.25 },
      { date: '2026-04-03', time: '17:00', retail: 0.15, nii: 0.18, qib: 0.16, total: 0.16 },
      { date: '2026-04-02', time: '17:00', retail: 0.08, nii: 0.10, qib: 0.08, total: 0.09 },
    ],
    expertReviews: [
      { id: '1', source: 'PR Sundar', sourceType: 'youtube', author: 'PR Sundar', summary: 'Weak subscription indicates poor demand. GMP falling steadily. Avoid this IPO for listing gains.', sentiment: 'negative', createdAt: '2026-04-04' },
      { id: '2', source: 'CA Rachana Ranade', sourceType: 'youtube', author: 'CA Rachana Ranade', summary: 'SME IPO with tepid response. Market conditions not favorable. Wait for better entry post-listing.', sentiment: 'negative', createdAt: '2026-04-03' },
      { id: '3', source: 'Moneycontrol', sourceType: 'news', author: 'Moneycontrol Research', summary: 'Emiac struggling to attract investors amid weak market sentiment. High risk of listing below issue price.', sentiment: 'negative', createdAt: '2026-04-04' },
      { id: '4', source: 'ICICI Direct', sourceType: 'firm', author: 'ICICI Direct Research', summary: 'Avoid rating. Poor subscription data and declining GMP signal weak listing. Not recommended.', sentiment: 'negative', createdAt: '2026-04-03' },
    ],
    peerCompanies: [
  ...
  },
  {
    ...
    gmpHistory: [
      ...
      { date: '2026-04-03', gmp: 12, gmpPercent: 10.0, source: 'InvestorGain' },
      { date: '2026-04-02', gmp: 15, gmpPercent: 12.5, source: 'IPOWatch' },
      { date: '2026-04-01', gmp: 18, gmpPercent: 15.0, source: 'IPOWatch' },
    ...
    expertReviews: [
      { id: '1', source: 'Akshat Shrivastava', sourceType: 'youtube', author: 'Akshat Shrivastava', summary: 'GMP dropping post-allotment. Market sentiment weak. Listing gains may be modest at best.', sentiment: 'neutral', createdAt: '2026-04-04' },
      { id: '2', source: 'Economic Times', sourceType: 'news', author: 'ET Markets', summary: 'Despite strong subscription, falling GMP indicates weak secondary market demand. Expect flat listing.', sentiment: 'neutral', createdAt: '2026-04-03' },
    ],
    peerCompanies: [
  ...
  },
  {
    ...
    gmpHistory: [
      { date: '2026-04-05', gmp: -12, gmpPercent: -3.0, source: 'IPOWatch' },
      { date: '2026-04-04', gmp: -8, gmpPercent: -2.0, source: 'IPOWatch' },
      { date: '2026-04-03', gmp: -5, gmpPercent: -1.3, source: 'InvestorGain' },
      { date: '2026-04-02', gmp: 2, gmpPercent: 0.5, source: 'IPOWatch' },
      { date: '2026-04-01', gmp: 5, gmpPercent: 1.3, source: 'IPOWatch' },
      { date: '2026-03-31', gmp: 8, gmpPercent: 2.0, source: 'IPOWatch' },
    ],
    subscriptionHistory: [
    ...
    expertReviews: [
      { id: '1', source: 'CNBC TV18', sourceType: 'news', author: 'CNBC Markets', summary: 'GMP turned negative. Expect listing below issue price. Avoid for listing gains.', sentiment: 'negative', createdAt: '2026-04-04' },
      { id: '2', source: 'Motilal Oswal', sourceType: 'firm', author: 'MOSL Research', summary: 'Downgrade to Avoid. Weak market conditions and negative GMP indicate poor listing prospects.', sentiment: 'negative', createdAt: '2026-04-03' },
      { id: '3', source: 'Zerodha Varsity', sourceType: 'youtube', author: 'Zerodha', summary: 'Power sector under pressure. This IPO may list at discount. Not recommended for short-term investors.', sentiment: 'negative', createdAt: '2026-04-04' },
    ],
    peerCompanies: [
  ...
  },
  {
    ...
    gmp: 5,
    gmpPercent: 2.9,
    gmpLastUpdated: '2026-04-05T12:00:00',
    estListPrice: 177,
    subscription: { total: 0, retail: '-', nii: '-', qib: '-', day: 0, isFinal: false },
    aiPrediction: -2.5,
    aiConfidence: 55,
